      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:pt-44 lg:pb-60 lg:px-8">
          <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl font-roboto">
            <span class="block text-white">Laravel Portugal 🇵🇹</span>
            <span class="block text-gray-100">Official Community</span>
          </h1>
          <p class="mt-6 max-w-lg mx-auto text-center text-xl text-white sm:max-w-3xl">
            Hello & Welcome to the official Laravel Community in Portugal. Engange with other Laravel Developers with active growing community
          </p>
